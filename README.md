...
```bash
docker build --target development --no-cache --tag ai-cffld-feedback-frontend:development .
```

Run:

```bash
docker run -p 3000:3000 ai-cffld-feedback-frontend:development
```
...
```bash
docker build --no-cache --tag ai-cffld-feedback-frontend .
```

Run:

```bash
docker run -p 3000:3000 ai-cffld-feedback-frontend
```
